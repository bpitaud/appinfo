...
<head>
    <meta charset="utf-8" />
    <link rel="stylesheet" href="NouveauMdpAdmin.css" />
...
<?php
    echo'
    <nav>
    	<a href="../Menu/Menu.php?user='.$_SESSION['selected_user'].'">Menu</a>/<a href="../Admin_Compte/Compte_Admin.php?user='.$_SESSION['selected_user'].'">Compte</a>/<span id="compte_link">Réinitialisation</span>
    </nav>';
    ?>
