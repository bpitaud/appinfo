...
<html>
    <head>
        ...
        <title>Domisep - List of sensors</title>
    ...
    <a href="../english/listepieces.php?log='.$piece[0][3].'">  < Back	
                ...
                $pie = RecupPieceID($piece);
                echo'
                <h2>Sensor(s) of the room : '.$pie[0][1].'</h2>';
    ?>
...
<?php
                ...
                if (isset($modif)) {
                    if ($modif == "true") {
                        echo "<p style='color:white;'>Your sensor has been modified.</p>";
                    } else if ($modif == "false") {
                        echo "<p style='color:red;'>Your sensor hasn't been modified.</p>";
                    }
                }
                ?>
...
<?php
                ...
                if (isset($supp)) {
                    if ($supp == "true") {
                        echo "<p style='color:white;'>Your sensor has been deleted.</p>";
                    } else if ($supp == "false"){
                        echo "<p style='color:red;'>Your sensor hasn't been deleted.</p>";
                    }
                }
                ?>
...
<?php
                ...
                if (isset($supp)) {
                    if ($supp == "existe") {
                        echo "<p style='color:red;'>This sensor already exists for you or another user.</p>";
                    } 
                }
                ?>
    ...
    <section>
        ...
        <?php
            ...
            if (count($capteurs) == 0 && count($controleurs)==0) {
                echo "<li> You don't have any sensors in this room.</li>";
                    ...
                    if ($type == 'lumiere'){
                        ...
                        <div class="'.$capteur[1].' block"> 
                            <div class="component-on figure show" >
                                <p style="color:#FFDA44"> <a href = "#"> <img src="../../Images/Capteur/on/iconeLumiere.png" alt="picture light" width="128" height="128"/></a>
                                <br/><br/> ON </p> 
                            </div>
                            <div  class="component-off figure hide">
                            <p><a href = "#"><img src="../../Images/Capteur/off/iconeLumiere.png" alt="picture light off"width="128" height="128"/></a>
                            <br/><br/> OFF </p>
                        </div>
                            <div class="caractère">
                            <p><a href = "../english/ModifCapteur.php?capteur='.$capteur[1].'"><img src="../../Images/Capteur/off/iconereglageblanc.png" alt="logo settings" width="39" height="39"/></a></p>
                            '.$capteur[0].'
                            </div>
                        </div>  ';    
                        } else {
                        ...
                        <div class="'.$capteur[1].' block"> 
                            ...
                            <div class="caractère">
                            <p><a href = "../english/ModifCapteur.php?capteur='.$capteur[1].'"><img src="../../Images/Capteur/off/iconereglageblanc.png" alt="logo réglage" width="39" height="39"/></a></p>
                            '.$capteur[0].'
                            </div>
                        </div>  ';
                        }
                ...
                foreach ($controleurs as $controleurs) {
                    ...
                    <div class="'.$controleurs[0].' block"> 
                        ...
                        <div class="caractère"> 
                        <p><a href = "../english/ModifControleur.php?capteur='.$controleurs[0].'"><img src="../../Images/Capteur/off/iconereglageblanc.png" alt="logo réglage" width="39" height="39"/></a></p>
                            '.$controleurs[1].'
                    ...
                    <div class="'.$controleurs[0].' block"> 
                        ...
                        <div class="'.$controleurs[0].' block"> 
                            ...
                            <div class="caractère"> 
                            <p><a href = "../Views/english/ModifControleur.php?capteur='.$controleurs[0].'"><img src="../../Images/Capteur/off/iconereglageblanc.png" alt="logo réglage" width="39" height="39"/></a></p>
                                '.$controleurs[1].' 
            ...
            <div class="ajoutcapteur"><a href="../english/AjoutCapteur.php?piece='.$_SESSION['selected_piece'].'"> 
             <p>+  Add a sensor</p>  
        </div></a>';
        ?>
